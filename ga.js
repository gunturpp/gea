function calculateFitness() {
  ...
  for (var i = 0; i < population.length; i++) {
    ...
    if (d < recordDistance) {
      ...
      document.getElementById("calFit").innerHTML = "&nbsp Record Distance : " + recordDistance + ", best distance : " + bestEver;
      
    }
    if (d < currentRecord) {
      currentRecord = d;
      currentBest = population[i];
      document.getElementById("calFit").innerHTML = "&nbsp Current Distance : " + currentBest + ", best distance : " + bestEver;
    }
